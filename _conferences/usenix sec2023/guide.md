...
<!-- Exclude for now, it doesn't seem necessary
...
This year we work together with Chameleon Cloud and Cloudlab.
...
Join Chameleon Cloud project: please send an email whose title starts with [JOIN CHAMELEON] to the chairs
...
Join Cloudlab project: TBD
Cloudlab Webinar: TBD

...
artifacts:
 ...
 - title: Leveraging Intensity as a New Feature to Detect Physical Adversarial Attacks
     Against LiDARs
   badges: available
 ...
 - title: 'SecurityHub: Electromagnetic Fingerprinting USB Peripherals using Backscatter-assisted
     Commodity Hardware'
   badges: reviewed
   artifact_url: https://github.com/zlab-pub/SecurityHub
 - title: 'R+R: Demystifying ML-Assisted Side-Channel Analysis Framework: A Case of
     Image Reconstruction'
   badges: reviewed
   artifact_url: https://github.com/zhenzhilai/ACSAC_ML_SCA_EVA/
 - title: 'You Only Perturb Once: Bypassing (Robust) Ad-Blockers Using Universal Adversarial
     Perturbations'
   badges: reviewed
 ...
 - title: 'R+R: Matrioska: A User-Centric Defense Against Virtualization-Based Repackaging
     Malware on Android'
   badges: reviewed
 ...
 - title: 'WiShield: Fine-grained Countermeasure Against Malicious Wi-Fi Sensing in
     Smart Home'
   badges: reviewed
 ...
 - title: 'Harnessing Multiplicity: Granular Browser Extension Fingerprinting through
     User Configurations'
   badges: reviewed
 ...
 - title: 'Reading It like an Open Book: Single-trace Blind Side-channel Attacks on
     Garbled Circuit Frameworks'
   badges: reviewed
 ...
 - title: On the Credibility of Backdoor Attacks Against Object Detectors in the Physical
     World
   badges: reviewed
 ...
 - title: 'VIMU: Effective Physics-based Realtime Detection and Recovery against Stealthy
     Attacks on UAVs'
   badges: reproducible
 ...
 - title: 'Sidecar: Leveraging Debugging Extensions in Commodity Processors to Secure
     Software'
   badges: reproducible
   artifact_url: https://github.com/kleftog/sidecar-ae
 - title: 'VaktBLE: A Benevolent Man-in-the-Middle Bridge to Guard against Malevolent
     BLE Connections'
   badges: reproducible
 ...
 - title: 'R+R: A Systematic Study of Cryptographic Function Identification Approaches
     in Binaries'
   badges: reproducible
   artifact_url: https://github.com/cryptobinarybenchmark/CryptoBinary-Benchmarks
 - title: 'ViTGuard: Attention-aware Detection against Adversarial Examples for Vision
     Transformer'
   badges: reproducible
   artifact_url: https://gitfront.io/r/user-5409342/8LbaoHMLR6nL/ViTGuard/
 - title: 'Leaky Autofill: An Empirical Study on the Privacy Threat of Password Managers''
     Autofill Functionality'
   badges: reproducible
   artifact_url: https://github.com/Leaky-Autofill/LeakyAutofill-Artifact
 - title: 'TATTOOED: A Robust Deep Neural Network Watermarking Scheme based on Spread-Spectrum
     Channel Coding'
   badges: reproducible
 ...
 - title: A Security Alert Investigation Tool Supporting Tier 1 Analysts in Contextualizing
     and Understanding Network Security Events
   badges: reproducible
   artifact_url: https://gitlab.tue.nl/aiss
 - title: 'CryptoPyt: Unraveling Python Cryptographic APIs Misuse With Precise Static
     Taint Analysis'
   badges: reproducible
 ...
 - title: 'I Can Show You the World (of Censorship): Extracting Insights from Censorship
     Measurement Data Using Statistical Techniques'
   badges: reproducible
...
Results automatically obtained from <a href="https://www.acsac.org/2024/program/artifacts/">ACSAC website</a>.
